...
__declspec_dll int mathCookingStage1(const CCTNum_t(*v)[3], const unsigned int* tri_indices, unsigned int tri_indices_cnt, const CCTNum_t(**ret_v)[3], unsigned int* ret_v_cnt, unsigned int** ret_tri_indices);
