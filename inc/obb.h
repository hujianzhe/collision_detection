...
__declspec_dll int OBB_Contain_Point(const GeometryOBB_t* obb, const CCTNum_t p[3]);
__declspec_dll int OBB_Intersect_OBB(const GeometryOBB_t* obb0, const GeometryOBB_t* obb1);
__declspec_dll int OBB_Contain_OBB(const GeometryOBB_t* obb0, const GeometryOBB_t* obb1);
