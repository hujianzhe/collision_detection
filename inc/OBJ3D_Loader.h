...
namespace obj3d
{
	...
	struct Vector3f
	{
		...
		Vector3f operator*(const double other) const
		{
	...
	namespace math
	{
		...
		double MagnitudeV3(const Vector3f& in)
		{
			return (sqrtf(powf(in.X, 2) + powf(in.Y, 2) + powf(in.Z, 2)));
		}

		double DotV3(const Vector3f& a, const Vector3f& b)
		{
			return (a.X * b.X) + (a.Y * b.Y) + (a.Z * b.Z);
		}

		double RadianBetweenV3(const Vector3f& a, const Vector3f& b)
		{
	...
	namespace algorithm
	{
		Vector3f operator*(double left, const Vector3f& right)
		{
